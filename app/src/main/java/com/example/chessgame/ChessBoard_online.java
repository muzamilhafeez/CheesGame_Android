...
public class ChessBoard_online extends AppCompatActivity implements View.OnClickListener {
    ActivityChessBoardOnlineBinding Binding;
...
////////////////////////////////////////////////////////////////////////////////////////
    private void initializePieces() {
        ...
        pieces[2][0] = new Piece("empty", 2, 0);
        pieces[2][1] = new Piece("empty", 2, 1);
        pieces[2][2] = new Piece("empty", 2, 2);
        pieces[2][3] = new Piece("empty", 2, 3);
        pieces[2][4] = new Piece("empty", 2, 4);
        pieces[2][5] = new Piece("empty", 2, 5);
        pieces[2][6] = new Piece("empty", 2, 6);
        pieces[2][7] = new Piece("empty", 2, 7);




        pieces[3][0] = new Piece("empty", 3, 0);
        pieces[3][1] = new Piece("empty", 3, 1);
        pieces[3][2] = new Piece("empty", 3, 2);
        pieces[3][3] = new Piece("empty", 3, 3);
        pieces[3][4] = new Piece("empty", 3, 4);
        pieces[3][5] = new Piece("empty", 3, 5);
        pieces[3][6] = new Piece("empty", 3, 6);
        pieces[3][7] = new Piece("empty", 3, 7);



        pieces[4][0] = new Piece("empty", 4, 0);
        pieces[4][1] = new Piece("empty", 4, 1);
        pieces[4][2] = new Piece("empty", 4, 2);
        pieces[4][3] = new Piece("empty", 4, 3);
        pieces[4][4] = new Piece("empty", 4, 4);
        pieces[4][5] = new Piece("empty", 4, 5);
        pieces[4][6] = new Piece("empty", 4, 6);
        pieces[4][7] = new Piece("empty", 4, 7);




        pieces[5][0] = new Piece("empty", 5, 0);
        pieces[5][1] = new Piece("empty", 5, 1);
        pieces[5][2] = new Piece("empty", 5, 2);
        pieces[5][3] = new Piece("empty", 5, 3);
        pieces[5][4] = new Piece("empty", 5, 4);
        pieces[5][5] = new Piece("empty", 5, 5);
        pieces[5][6] = new Piece("empty", 5, 6);
        pieces[5][7] = new Piece("empty", 5, 7);
            ...
            api.GETNEXTMOVEDETAILS_CALL(GlobalData.obj.id, GlobalData.matchId).enqueue(new Callback<getnextmovedetails>() {
                ...
                public void onResponse(Call<getnextmovedetails> call, Response<getnextmovedetails> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (obj.id != moveId) {
                            moveId = obj.id;
                            Toast.makeText(ChessBoard_online.this, ""+obj.tocol+":"+obj.fromcol, Toast.LENGTH_SHORT).show();
...
//                        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Binding = ActivityChessBoardOnlineBinding.inflate(getLayoutInflater());
...
//                        torow = -1;
                    ...
                    if (ismoving) {
                        ...
                        if (isValidMove(new Position(i, j))) {
                            ...
                            Toast.makeText(ChessBoard_online.this, "Invalid Move", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    }
    ...
    private void sendMoveToApi(int fromR, int fromC, int toR, int toC) {
        ...
        api.newMove(map).enqueue(new Callback<Integer>() {
            ...
            public void onFailure(Call<Integer> call, Throwable t) {
                Toast.makeText(getApplicationContext(), "new"+t.toString(), Toast.LENGTH_SHORT).show();
            }
        });
